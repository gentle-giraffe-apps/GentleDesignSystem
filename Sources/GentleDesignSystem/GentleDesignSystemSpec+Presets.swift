...
public extension GentleDesignSystemSpec {
    ...
    static let classic: GentleDesignSystemSpec = {
        ...
        spec.colors = GentleColorTokens(pairByRole: [
            ...
            GentleColorRole.onOverlay.rawValue:   .init(lightHex: "#FAF8F3", darkHex: "#FAF8F3"),
            GentleColorRole.onOverlaySecondary.rawValue: .init(lightHex: "#D4C8B4", darkHex: "#D4C8B4"),
    ...
    static let modern: GentleDesignSystemSpec = {
        ...
        spec.colors = GentleColorTokens(pairByRole: [
            ...
            GentleColorRole.onOverlay.rawValue:   .init(lightHex: "#FAFAFC", darkHex: "#FAFAFC"),
            GentleColorRole.onOverlaySecondary.rawValue: .init(lightHex: "#B0B0C4", darkHex: "#B0B0C4"),
    ...
    static let soft: GentleDesignSystemSpec = {
        ...
        spec.colors = GentleColorTokens(pairByRole: [
            ...
            GentleColorRole.onOverlay.rawValue:   .init(lightHex: "#F5FAF8", darkHex: "#F5FAF8"),
            GentleColorRole.onOverlaySecondary.rawValue: .init(lightHex: "#B8D4C8", darkHex: "#B8D4C8"),
    ...
    static let editorial: GentleDesignSystemSpec = {
        ...
        spec.colors = GentleColorTokens(pairByRole: [
            ...
            GentleColorRole.onOverlay.rawValue:   .init(lightHex: "#FFFFFF", darkHex: "#FFFFFF"),
            GentleColorRole.onOverlaySecondary.rawValue: .init(lightHex: "#CCCCCC", darkHex: "#CCCCCC"),
    ...
    static let technical: GentleDesignSystemSpec = {
        ...
        spec.colors = GentleColorTokens(pairByRole: [
            ...
            GentleColorRole.onOverlay.rawValue:   .init(lightHex: "#F0F7FC", darkHex: "#F0F7FC"),
            GentleColorRole.onOverlaySecondary.rawValue: .init(lightHex: "#A3C4E0", darkHex: "#A3C4E0"),
    ...
    static let bold: GentleDesignSystemSpec = {
        ...
        spec.colors = GentleColorTokens(pairByRole: [
            ...
            GentleColorRole.onOverlay.rawValue:   .init(lightHex: "#FFF8F3", darkHex: "#FFF8F3"),
            GentleColorRole.onOverlaySecondary.rawValue: .init(lightHex: "#E0C4B0", darkHex: "#E0C4B0"),
    ...
    static let elegant: GentleDesignSystemSpec = {
        ...
        spec.colors = GentleColorTokens(pairByRole: [
            ...
            GentleColorRole.onOverlay.rawValue:   .init(lightHex: "#F8F5FF", darkHex: "#F8F5FF"),
            GentleColorRole.onOverlaySecondary.rawValue: .init(lightHex: "#D0C0E8", darkHex: "#D0C0E8"),
    ...
    static let compact: GentleDesignSystemSpec = {
        ...
        spec.colors = GentleColorTokens(pairByRole: [
            ...
            GentleColorRole.onOverlay.rawValue:   .init(lightHex: "#F2F8F5", darkHex: "#F2F8F5"),
            GentleColorRole.onOverlaySecondary.rawValue: .init(lightHex: "#B8D4C4", darkHex: "#B8D4C4"),
